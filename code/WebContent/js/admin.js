...
function insert(object) {
    ...
    if (object == "user") {
        ...
        else if(user[3].checked == true)
            level = user[3].value.toString();
        else
        	level = user[4].value.toString();
...
function show_alter(object) {
    ...
    if (object == "user") {
        show = "<div id='alter_user'  class='d_form'>"
            ...
            + "<input type='radio' name='after_level' value='学生''><span>学生</span>"
            + "</div>"
...
function alter_user() {
    ...
    else if(user[4].checked == true)
        after_level = user[4].value.toString();
    else
    	after_level = user[5].value.toString();
