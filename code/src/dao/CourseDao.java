...
public class CourseDao {
	...
	public ArrayList<Course> query_my(String username) {
		Connection conn = DBUtils.getConnection();
		String sql = "select course.cno,cname,cteacher,ccredit from sc,student,course where student.sname=? and sc.sno = student.sno and course.cno = sc.cno order by cno;";
		ArrayList<Course> results = new ArrayList<Course>();
		try {
			PreparedStatement ps = (PreparedStatement) conn.prepareStatement(sql);
